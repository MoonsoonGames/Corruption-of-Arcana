...
namespace Necropanda
{
    public class VFXManager : MonoBehaviour
    {
        ...
        public void AffectSelfDelay(Spell spellRef, Character caster, CombatHelperFunctions.SpellModule spell, int cardsDiscarded, int removedStatuses, Vector2 spawnPosition, float delay, bool empowered, bool weakened)
        {
            StartCoroutine(IDelayAffectSelf(spellRef, caster, spell, cardsDiscarded, removedStatuses, spawnPosition, delay, empowered, weakened));
        }

        IEnumerator IDelayAffectSelf(Spell spellRef, Character caster, CombatHelperFunctions.SpellModule spell, int cardsDiscarded, int removedStatuses, Vector2 spawnPosition, float delay, bool empowered, bool weakened)
        {
            ...
            spellRef.AffectSelf(caster, spell, cardsDiscarded, removedStatuses, empowered, weakened);
        }

        public void AffectTargetDelay(Spell spellRef, Character caster, Character target, CombatHelperFunctions.SpellModule spell, int cardsDiscarded, int removedStatuses, Vector2 spawnPosition, float delay, bool empowered, bool weakened)
        {
            StartCoroutine(IDelayAffectTarget(spellRef, caster, target, spell, cardsDiscarded, removedStatuses, spawnPosition, delay, empowered, weakened));
        }

        IEnumerator IDelayAffectTarget(Spell spellRef, Character caster, Character target, CombatHelperFunctions.SpellModule spell, int cardsDiscarded, int removedStatuses, Vector2 spawnPosition, float delay, bool empowered, bool weakened)
        {
            yield return new WaitForSeconds(delay);
            ...
            yield return new WaitForSeconds(effectDelay);
            spellRef.AffectTarget(caster, target, spell, cardsDiscarded, removedStatuses, empowered, weakened);
        }
